...
export FZF_DEFAULT_COMMAND='ag -l --nogroup --nocolor --column'
...
# chrome/v8/d8/wasm {{{
export PATH=$HOME/bin:$HOME/ssd2/wabt/bin:$HOME/ssd1/depot_tools:$HOME/ssd1/v8/v8/tools/dev:$PATH
...
# clang {{{
[[ -f ~/src/llvm-project/clang/utils/bash-autocomplete.sh ]] && source ~/src/llvm-project/clang/utils/bash-autocomplete.sh
# }}}
